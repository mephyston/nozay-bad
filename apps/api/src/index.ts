...
app.post('/bank-transactions/analyze', async (c) => {
  ...
  for (const tx of pendingTxs) {
    ...
    if (
      ...
      textToLower.includes('stage toussaint') ||
...
5. Si le libellé bancaire ou le mémo mentionne des déplacements, tournois, accompagnements pour les jeunes (ex: "deplacement jeune", "tournoi jeune") ou des stages de vacances scolaires pour jeunes (ex: "stage toussaint", "stage d'hiver", "stage de printemps", "stage jeunes", "course stage hivers"), choisis impérativement la catégorie 4 (actions_jeunes) au lieu de la catégorie 9 (salaires_charges) ou 13 (stages_formations).
