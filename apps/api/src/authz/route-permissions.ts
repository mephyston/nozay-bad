...
export const ROUTE_PERMISSIONS: RouteRule[] = [
  ...
  { method: 'POST', path: '/accounting/bank-statement-lines/status-bulk', permission: 'accounting:bank:reconcile' },
  ...
  { method: 'POST', path: '/accounting/bank-transactions/status-bulk', permission: 'accounting:bank:reconcile' },
