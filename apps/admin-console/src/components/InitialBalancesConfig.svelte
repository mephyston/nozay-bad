<script lang="ts">
  import { Wallet2, Check, Loader2, Save } from "lucide-svelte";
      ...
      <div class="space-y-1">
        ...
        <div class="relative">
          <input 
            ...
            type="number" 
            step="0.01" 
            class="w-full pl-3 pr-6 py-2 border border-border bg-background rounded-md text-sm outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-foreground font-semibold" 
