...
**Cinq rôles, cumulables.** `super_admin`, `president`, `tresorier`, `secretaire`, `membre`. Un compte peut en porter plusieurs ; ses droits sont l'union des leurs. Une même personne assurant deux fonctions reçoit deux rôles, plutôt qu'un rôle sur mesure.
...
| | Membre | Secrétaire | Trésorier | Président | Super admin |
|---|---|---|---|---|---|
