...
**Le bureau désigne les ouvreurs**, par saison. Ce sont les détenteurs d'un badge d'accès aux gymnases. La liste ne stocke que des **licences** : c'est une liste *courante*, et y recopier un prénom le laisserait diverger de l'annuaire. Les noms sont résolus par l'écran qui les affiche.

**Cette liste n'est pas une fonction au club.** Les fonctions (président, trésorier…) n'admettent qu'un titulaire par personne et par saison, et se décident en assemblée générale ; or les détenteurs de badge *sont* souvent les gens du bureau, et un badge change quand la mairie les refait. Deux natures de chose, deux listes.
...
**L'identité de l'ouvreur est recopiée sur la séance**, contrairement à la liste. Elle y devient une **trace** : qui a réellement ouvert le gymnase ce soir-là. Reprendre son badge plus tard ne doit pas effacer son nom des séances qu'il a tenues.
...
Fonctionnalité: Ouvreurs désignés et confirmation d'une séance
  ...
  Scénario: Le bureau confie un badge
  ...
  Scénario: Reprendre un badge ne défait pas le passé
    Étant donné Marie qui a ouvert deux séances cette saison
    Quand le bureau lui reprend son badge
  ...
  Scénario: Aucun ouvreur désigné
    Étant donné une saison où personne n'a reçu de badge
