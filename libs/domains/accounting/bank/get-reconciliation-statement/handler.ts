...
import { computeAccountBalance, signedEntryAmountCents, type AccountRef } from '../../shared/balances';
import {
 ...
 * égalité — `gapCents` — n'est explicable par aucun décalage de traitement. Trois causes
 * possibles, dans cet ordre de fréquence : un relevé pas encore importé jusqu'à la date
 * d'arrêté, un appariement inexact (une écriture pointée pour un montant différent de sa
 * ligne), ou un à-nouveau qui ne correspond pas au solde bancaire d'ouverture de l'exercice.
 *
