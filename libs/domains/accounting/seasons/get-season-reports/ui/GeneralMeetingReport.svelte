...
<div class="space-y-6">
  <Tabs.Root bind:value={activeTab} class="space-y-6">
    <Tabs.List class="grid w-full max-w-2xl mx-auto grid-cols-3 mb-6 no-print">
      <Tabs.Trigger value="resultat" onclick={() => activeTab = 'resultat'}>Compte de résultat</Tabs.Trigger>
      <Tabs.Trigger value="tresorerie" onclick={() => activeTab = 'tresorerie'}>Bilan de trésorerie</Tabs.Trigger>
      <Tabs.Trigger value="budget" onclick={() => activeTab = 'budget'}>Budget prévisionnel</Tabs.Trigger>
    </Tabs.List>
