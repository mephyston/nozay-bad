...
export type CloseSeasonCheckItem = {
  code: 'ALREADY_CLOSED' | 'BEFORE_END_DATE' | 'PENDING_BANK_TRANSACTIONS' | 'UNRESOLVED_CHECK_DEPOSITS' | 'UNCLAIMED_IN_VAULT_CHECKS' | 'PENDING_DEBIT_TRANSACTIONS' | 'CASH_DISCREPANCY';
  message: string;
  details?: any;
};
