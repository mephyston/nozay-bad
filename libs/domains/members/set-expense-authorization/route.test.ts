...
describe('setExpenseAuthorizationRoute (PATCH /:id/expense-authorization)', () => {
  ...
  beforeEach(async () => {
    ...
    await m.db.insert(membersTable).values({ id: 1, licence: '1000001', seasonId: 1, lastName: 'X', firstName: 'Y', gender: 'M', birthDate: '2010-01-01', type: 'jeune', importedAt: new Date() }).run();
  });
